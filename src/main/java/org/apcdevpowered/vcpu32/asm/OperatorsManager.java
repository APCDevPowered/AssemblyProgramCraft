...
public class OperatorsManager
{
    ...
    public static final Operator optSET = new MachineInsnOperator("SET", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeReal, typeLabel)), 0x001);
    public static final Operator optADD = new MachineInsnOperator("ADD", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x002);
    public static final Operator optSUB = new MachineInsnOperator("SUB", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x003);
    public static final Operator optMUL = new MachineInsnOperator("MUL", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x004);
    public static final Operator optDIV = new MachineInsnOperator("DIV", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x005);
    public static final Operator optMOD = new MachineInsnOperator("MOD", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x006);
    public static final Operator optAND = new MachineInsnOperator("AND", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x007);
    public static final Operator optBOR = new MachineInsnOperator("BOR", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x008);
    public static final Operator optXOR = new MachineInsnOperator("XOR", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x009);
    public static final Operator optSHR = new MachineInsnOperator("SHR", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x00a);
    public static final Operator optASR = new MachineInsnOperator("ASR", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x00b);
    public static final Operator optSHL = new MachineInsnOperator("SHL", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x00c);
    public static final Operator optIFE = new MachineInsnOperator("IFE", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x00d);
    public static final Operator optIFN = new MachineInsnOperator("IFN", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x00e);
    public static final Operator optIFA = new MachineInsnOperator("IFA", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x00f);
    public static final Operator optIFU = new MachineInsnOperator("IFU", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x010);
    public static final Operator optJSR = new MachineInsnOperator("JSR", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel)), 0x011);
    public static final Operator optCRT = new MachineInsnOperator("CRT", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeString)), 0x020);
    public static final Operator optSTT = new MachineInsnOperator("STT", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x021);
    public static final Operator optGTH = new MachineInsnOperator("GTH", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)), 0x022);
    public static final Operator optEXT = new MachineInsnOperator("EXT", Arrays.asList(ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x023);
    public static final Operator optSLT = new MachineInsnOperator("SLT", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x024);
    public static final Operator optCLCK = new MachineInsnOperator("CLCK", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)), 0x025);
    public static final Operator optDLCK = new MachineInsnOperator("DLCK", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x026);
    public static final Operator optGLCK = new MachineInsnOperator("GLCK", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x027);
    ...
    public static final Operator optINS = new MachineInsnOperator("INS", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel),
            ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel)), 0x042);
    public static final Operator optOUTS = new MachineInsnOperator("OUTS", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel),
            ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel)), 0x043);
    public static final Operator optMIOP = new MachineInsnOperator("MIOP", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel),
            ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel)), 0x044);
    public static final Operator optUNMP = new MachineInsnOperator("UNMP", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel)), 0x045);
    public static final Operator optGDT = new MachineInsnOperator("GDT", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)), 0x046);
    public static final Operator optPUSH = new MachineInsnOperator("PUSH", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x050);
    public static final Operator optPOP = new MachineInsnOperator("POP", Arrays.asList(ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)), 0x051);
    public static final Operator optDUP = new MachineInsnOperator("DUP", Arrays.asList(ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x052);
    public static final Operator optSWAP = new MachineInsnOperator("SWAP", Collections.<ParDatatypes> emptyList(), 0x053);
    public static final Operator optCALL = new MachineInsnOperator("CALL", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel), ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x060);
    public static final Operator optRET = new MachineInsnOperator("RET", Arrays.asList(ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x061);
    public static final Operator optGPL = new MachineInsnOperator("GPL", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeVoid, typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel)), 0x062);
    public static final Operator optITF = new MachineInsnOperator("ITF", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeChar, typeHex, typeOct, typeBin, typeDec, typeReg, typeLabel), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)), 0x070);
    public static final Operator optFTI = new MachineInsnOperator("FTI", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)), 0x071);
    public static final Operator optFADD = new MachineInsnOperator("FADD", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x080);
    public static final Operator optFSUB = new MachineInsnOperator("FSUB", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x081);
    public static final Operator optFMUL = new MachineInsnOperator("FMUL", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x082);
    public static final Operator optFDIV = new MachineInsnOperator("FDIV", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x083);
    public static final Operator optFMOD = new MachineInsnOperator("FMOD", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x084);
    public static final Operator optFIFE = new MachineInsnOperator("FIFE", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x090);
    public static final Operator optFIFN = new MachineInsnOperator("FIFN", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x091);
    public static final Operator optFIFA = new MachineInsnOperator("FIFA", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x092);
    public static final Operator optFIFU = new MachineInsnOperator("FIFU", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal), ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg, typeReal)), 0x093);
    public static final Operator optDAT = new DummyVariableParametersOperator("DAT")
    {
        public final ParDatatypes par1Datatypes = ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg);
    ...
    public static final Operator optGSO = new DummyOperator("GSO", Arrays.asList(ParDatatypes.fromDatatypes(typeMemDec, typeMemHex, typeMemOct, typeMemBin, typeMemReg, typeMemLabel, typeReg)))
    {
        @Override
        public void addToProgram(FragmentProgram program, int lineNumber, List<Datatype<?>> datatypes, List<String> parImages, CompileContext context) throws ParImageFormatException
        {
