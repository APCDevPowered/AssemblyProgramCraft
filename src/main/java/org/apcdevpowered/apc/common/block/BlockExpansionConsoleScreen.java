...
/**
 * The block of expansion console screen.
 * 
 * @author yuxuanchiadm
 * @see org.apcdevpowered.apc.common.tileEntity.TileEntityExpansionConsoleScreen
 * @see org.apcdevpowered.apc.client.renderer.tileentity.RenderTileEntityExpansionConsoleScreen
 * @see org.apcdevpowered.apc.common.block.BlockExternalDeviceConsoleScreen
 * @since a1.0.1
 */
public class BlockExpansionConsoleScreen extends BlockContainer
{
     ...
     * Constructs a block.
     */
    public BlockExpansionConsoleScreen()
    {
        super(Material.rock);
    ...
    {
        return new TileEntityExpansionConsoleScreen();
    }
    /**
