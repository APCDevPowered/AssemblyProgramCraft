...
/**
 * The block of external device console screen.
 * 
 * @author yuxuanchiadm
 * @see org.apcdevpowered.apc.common.tileEntity.TileEntityExternalDeviceConsoleScreen
 * @see org.apcdevpowered.vcpu32.vm.extdev.ExternalDeviceConsoleScreen
 * @see org.apcdevpowered.apc.client.renderer.tileentity.RenderTileEntityExternalDeviceConsoleScreen
 * @see org.apcdevpowered.apc.common.block.BlockExpansionConsoleScreen
 * @since a1.0.0
 */
public class BlockExternalDeviceConsoleScreen extends BlockExternlaDevice
{
     ...
     * Constructs a block.
     */
    public BlockExternalDeviceConsoleScreen()
    {
        super(Material.rock);
    ...
    {
        return new TileEntityExternalDeviceConsoleScreen();
    }
    /**
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (iblockstate.getBlock() == this)
        {
            ...
            {
                this.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 4.0F / 16.0F);
            }
            ...
            {
                this.setBlockBounds(0.0F, 0.0F, 0.0F, 4.0F / 16.0F, 1.0F, 1.0F);
            }
        }
    }
    /**
