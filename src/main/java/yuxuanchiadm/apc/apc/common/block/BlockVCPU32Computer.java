 ...
 * 
 * @author yuxuanchiadm
 * @see yuxuanchiadm.apc.apc.common.tileEntity.TileEntityVCPU32Computer
 * @see yuxuanchiadm.apc.apc.client.renderer.tileentity.RenderTileEntityVCPU32Computer
 * @see yuxuanchiadm.apc.vcpu32.vm.VirtualMachine
 * @since a1.0.0
 */
