 ...
 * 
 * @author yuxuanchiadm
 * @see yuxuanchiadm.apc.apc.common.tileEntity.TileEntityVCPU32ComputerWire
 * @see yuxuanchiadm.apc.apc.client.renderer.tileentity.RenderTileEntityVCPU32ComputerWire
 * @since a1.0.0
 */
