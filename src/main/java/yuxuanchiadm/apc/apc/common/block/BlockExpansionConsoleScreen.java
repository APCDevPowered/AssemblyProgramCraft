 ...
 * 
 * @author yuxuanchiadm
 * @see yuxuanchiadm.apc.apc.common.tileEntity.TileEntityExpansionConsoleScreen
 * @see yuxuanchiadm.apc.apc.client.renderer.tileentity.RenderTileEntityExpansionConsoleScreen
 * @see yuxuanchiadm.apc.apc.common.block.BlockExternalDeviceConsoleScreen
 * @since a1.0.1
 */
