 ...
 * 
 * @author yuxuanchiadm
 * @see yuxuanchiadm.apc.apc.common.tileEntity.TileEntityVCPU32ComputerConnector
 * @see yuxuanchiadm.apc.apc.client.renderer.tileentity.RenderTileEntityVCPU32ComputerConnector
 * @see yuxuanchiadm.apc.apc.common.util.ConnectorFinder
 * @since a1.0.0
 */
