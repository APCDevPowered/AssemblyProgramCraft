...
/**
 * The block of external device monitor.
 * 
 * @author yuxuanchiadm
 * @see yuxuanchiadm.apc.apc.common.tileEntity.TileEntityExternalDeviceMonitor
 * @see yuxuanchiadm.apc.vcpu32.extdev.ExternalDeviceMonitor
 * @see yuxuanchiadm.apc.apc.client.renderer.tileentity.RenderTileEntityExternalDeviceMonitor
 * @since a1.0.0
 */
public class BlockExternalDeviceMonitor extends BlockExternlaDevice
{
