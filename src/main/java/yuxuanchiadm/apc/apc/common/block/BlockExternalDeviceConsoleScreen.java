 ...
 * 
 * @author yuxuanchiadm
 * @see yuxuanchiadm.apc.apc.common.tileEntity.TileEntityExternalDeviceConsoleScreen
 * @see yuxuanchiadm.apc.vcpu32.extdev.ExternalDeviceConsoleScreen
 * @see yuxuanchiadm.apc.apc.client.renderer.tileentity.RenderTileEntityExternalDeviceConsoleScreen
 * @see yuxuanchiadm.apc.apc.common.block.BlockExpansionConsoleScreen
 * @since a1.0.0
 */
