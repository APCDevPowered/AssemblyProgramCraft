package yuxuanchiadm.apc.apc.gui.components;
...
import yuxuanchiadm.apc.apc.gui.event.IEventNode;
...
public class GuiMultipleLineTextField extends Gui implements IEventNode
{
     ...
     * When set cursor between '\r' and '\n' will cause unstable status.
     * Then do something may cause game crash.
     * 
     * May only use this method set cursor to 0 or text.length().
     * Or be sure string don`t has "\r\n".
     * Faster a bit with {@link #setCursorSafety(int, boolean)}
     * 
     ...
     * Will forward 1 char or backward 1 char when cursor between '\r' and '\n'.
     * 
     * @param cursor The new cursor
     * @param fallbackChar When between '\r' and '\n' will cause fallback 1 char
     */
    ...
    /**
     * Forward cursor 1 char.
     * Safe even string has "\r\n".
     */
    ...
    public void checkCursorDisplay()
    {
        ...
        /*
        System.out.println("---------------------------------------------------------------------");
        System.out.println("cursorMinHorizontalPos : " + cursorMinHorizontalPos);
        System.out.println("cursorMinVerticalPos : " + cursorMinVerticalPos);
        System.out.println("cursorMaxHorizontalPos : " + cursorMaxHorizontalPos);
        System.out.println("cursorMaxVerticalPos : " + cursorMaxVerticalPos);
        System.out.println("scrollH : " + scrollH);
        System.out.println("scrollV : " + scrollV);
        System.out.println("maxScrollH : " + maxScrollH);
        System.out.println("maxScrollV : " + maxScrollV);
        System.out.println("transformScrollH : " + transformScrollH);
        System.out.println("transformScrollV : " + transformScrollV);
        System.out.println("transformMaxScrollH : " + transformMaxScrollH);
        System.out.println("transformMaxScrollV : " + transformMaxScrollV);
        System.out.println("---------------------------------------------------------------------");
        */
    }
    @Override
    ...
    public void keyPressed(char character, int key)
    {
        if(isFocused && isInteractive)
        {
            ...
            else if(character == 22 && isEditable)
            {
    ...
    public void renderAdvancedCharAtPos(char theChar,int xPos,int yPos,int topCut,int buttomCut,int leftCut,int rightCut,int color)
    {
        ...
        else
        {
            ...
            GL11.glTexCoord2d(var8 / 256.0D + leftCut / 256.0D + 0.004D * leftCut, var9 / 256.0D + topCut / 256.0D + 0.004D * topCut);
            GL11.glVertex3d(xPos + leftCut, yPos + topCut, 0.0D);
            GL11.glTexCoord2d(var8 / 256.0D + leftCut / 256.0D + 0.004D * leftCut, (var9 + 16.0D) / 256.0D - buttomCut / 256.0D - 0.004D * buttomCut);
            GL11.glVertex3d(xPos + leftCut, yPos + 8.0D - buttomCut, 0.0D);
            GL11.glTexCoord2d((var8 + var10) / 256.0D - rightCut / 256.0D - 0.004D * rightCut, var9 / 256.0D + topCut / 256.0D + 0.004D * topCut);
            GL11.glVertex3d(xPos + var10 / 2.0D - rightCut, yPos + topCut, 0.0D);
            GL11.glTexCoord2d((var8 + var10) / 256.0D - rightCut / 256.0D - 0.004D * rightCut, (var9 + 16.0D) / 256.0D - buttomCut / 256.0D - 0.004D * buttomCut);
            GL11.glVertex3d(xPos + var10 / 2.0D - rightCut, yPos + 8.0D - buttomCut, 0.0D);
            GL11.glEnd();
        }
    }
