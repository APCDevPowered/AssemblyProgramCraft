...
{
    private static final ResourceLocation guiKeyboardTextures = new ResourceLocation("AssemblyProgramCraft:textures/gui/GuiKeyboard.png");
    ...
    protected void keyTyped(char par1, int par2)
    {
        ...
        pak.dataByte[0] = 1;
        pak.dataInt[0] = keyboard.xCoord;
        pak.dataInt[1] = keyboard.yCoord;
        pak.dataInt[2] = keyboard.zCoord;
        pak.dataInt[3] = keyboard.getWorldObj().getWorldInfo().getVanillaDimension();
        pak.dataInt[4] = par1;
